<?php
	...
	{	//session_unset();
		global $users; //Se utiliza cuando esta en un ambito mas interno
...
<body>
	<?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST"){
			...
			if(isset($_POST['username'])) //pregunta si el valor esta seteado, es para que no
			//de error si no se habia definido
				$username = $_POST['username'];

			if(isset($_POST['password']))
				$password = $_POST['password'];

			if(!empty($username) && !empty($password)) //verifica que el valor no este vacio
