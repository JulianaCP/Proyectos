...
angular.module('mantenimientoApp')
    .controller('homeCtrl', function($scope,$http) {
        ...
        var tipoUsuario = "N";
        var ur = "http://172.24.42.196:8090/Usuarios/obtenerListaUsuarios/" + tipoUsuario;
        console.log("ur: "+ur);
        $http({
            method: "GET",
            url: ur
        ...
        $scope.eliminar = function eliminar(valorEliminar) {
            ...
            //eliminar
            var ur = "http://172.24.42.196:8090/Usuarios/eliminarUsuario/" + valorEliminar;
            $http({
                method: "POST",
                url: ur
            }).success(function (result) {
