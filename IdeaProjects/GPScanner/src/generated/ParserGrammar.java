...
public class ParserGrammar extends Parser {
	...
	public static class CondeclsContext extends ProgramContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitCondecls(this);
	...
	public static class SindeclsContext extends ProgramContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitSindecls(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclsContext extends DeclarationsContext {
		...
		public List<TerminalNode> PyCOMA() { return getTokens(ParserGrammar.PyCOMA); }
		public TerminalNode PyCOMA(int i) {
			return getToken(ParserGrammar.PyCOMA, i);
		}
		public DeclsContext(DeclarationsContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitDecls(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IntdeclContext extends DeclarationContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitIntdecl(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StrdeclContext extends DeclarationContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitStrdecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StatsContext extends StatementsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitStats(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EpsstatContext extends StatementContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitEpsstat(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExprstatContext extends StatementContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitExprstat(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AsignstatContext extends StatementContext {
		public TerminalNode ID() { return getToken(ParserGrammar.ID, 0); }
		public TerminalNode ASIGN() { return getToken(ParserGrammar.ASIGN, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitAsignstat(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ExpressionContext {
		...
		public List<TerminalNode> SUMA() { return getTokens(ParserGrammar.SUMA); }
		public TerminalNode SUMA(int i) {
			return getToken(ParserGrammar.SUMA, i);
		}
	...
	public static class Term1Context extends TermContext {
		...
		public List<TerminalNode> MUL() { return getTokens(ParserGrammar.MUL); }
		public TerminalNode MUL(int i) {
			return getToken(ParserGrammar.MUL, i);
		}
		public Term1Context(TermContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitTerm1(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NumfactContext extends FactorContext {
		public TerminalNode NUM() { return getToken(ParserGrammar.NUM, 0); }
		public NumfactContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitNumfact(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class GroupfactContext extends FactorContext {
		public TerminalNode PIZQ() { return getToken(ParserGrammar.PIZQ, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public TerminalNode PDER() { return getToken(ParserGrammar.PDER, 0); }
		public GroupfactContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitGroupfact(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StrfactContext extends FactorContext {
		public TerminalNode STR() { return getToken(ParserGrammar.STR, 0); }
		public StrfactContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitStrfact(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IdfactContext extends FactorContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitIdfact(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Idlist1Context extends IdlistContext {
		...
		public List<TerminalNode> COMA() { return getTokens(ParserGrammar.COMA); }
		public TerminalNode COMA(int i) {
			return getToken(ParserGrammar.COMA, i);
		}
		public Idlist1Context(IdlistContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserGrammarVisitor ) return ((ParserGrammarVisitor<? extends T>)visitor).visitIdlist1(this);
			else return visitor.visitChildren(this);
		}
	}
